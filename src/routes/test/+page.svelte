...
<div class="min-h-screen bg-gray-50 dark:bg-slate-900 flex items-center justify-center px-4">
	<div class="max-w-md w-full">
		<div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-8 text-center">
			<h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">🧪 Página de Teste</h1>
			...
			<div class="space-y-3">
				...
				{#if initMessage}
					<div
						class="p-3 {initMessage.startsWith('✅')
							? 'bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800 text-green-700 dark:text-green-300'
							: 'bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800 text-red-700 dark:text-red-300'} border rounded-lg"
					>
